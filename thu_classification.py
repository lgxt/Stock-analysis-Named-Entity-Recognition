...
if os.name == 'nt':
    ...
    # lucas修改项目的训练目录
    bert_path = "D:\lucas\Bert+BiLSTM+CRF-linux-GuQuanAnalyse3-newBert\lucas_bert"
    root_path = r'D:\lucas\Bert+BiLSTM+CRF-linux-GuQuanAnalyse3-newBert'
else:
#     bert_path = '/home/macan/ml/data/chinese_L-12_H-768_A-12'
#     root_path = '/home/macan/ml/workspace/BERT_Base2'
    # lucas修改项目的训练目录
    bert_path = "/Share/Bert+BiLSTM+CRF-GPUlinux-GuQuanAna3-newBert/lucas_bert"
    root_path = "/Share/Bert+BiLSTM+CRF-GPUlinux-GuQuanAna3-newBert"
